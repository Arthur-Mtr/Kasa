    ...
    return (
        <section className="about-page">
            ...
            <div className="collapse">
                ...
                <Collapse title="Service" content={<p>La qualité du service est au cœur de notre engagement chez Kasa. Nous veillons à ce que chaque interaction, que ce soit avec nos hôtes ou nos locataires, soit empreinte de respect et de bienveillance.</p>}/>
